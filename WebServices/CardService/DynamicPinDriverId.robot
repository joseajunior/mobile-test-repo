...
Documentation  This is to test the endpoint GET for (GET generateDynamicPinWithPromptByDriverId)
...
#-----------------------------------------------------------------------------------#
#              Endpoint POST:  /otr-cards/generate-dynamic-pin/driver-id            #
#-----------------------------------------------------------------------------------#
Get DynamicPinResponse 200
    [Documentation]  Test the successful scenario to GET DynamicPinResponse By DriverId
    [Tags]   Q1:2023  JIRA:ATLAS-2294  JIRA:ATLAS-2365  JIRA:2409  qTest:119412734
    ${response}  Send Request  200
    Check Response  200  ${response}

Get DynamicPinResponse 400
    [Documentation]  Test the error scenario to GET DynamicPinResponse By DriverId
    ...  When the request is malformed or any user input is invalid
    [Tags]  Q1:2023  JIRA:ATLAS-2294  qTest:119376145
...
Get DynamicPinResponse 401
    ...
    [Tags]  Q1:2023  JIRA:ATLAS-2294  qTest:119376147
...
Get DynamicPinResponse 422 (carrier_id)
    ...
    [Tags]  Q1:2023  JIRA:ATLAS-2294  qTest:119376148
...
Get DynamicPinResponse 422 (card_number)
    [Documentation]  Test the error scenario to GET DynamicPinResponse By DriverId
    ...  When the input does not pass validation and is unprocessable.
    [Tags]   Q1:2023  JIRA:ATLAS-2294  qTest:119376149
...
Setup
    Get Bearer Token
    ${requestEndpoint}  catenate  ${cardsservice}/otr-cards/generate-dynamic-pin/driver-id
...
Send Request
    ...
    [Return]  ${response}
    IF  ${val} == 200
      ${data}  Create dictionary  carrier_id=100004  driver_or_unit_id=NFX05
    ...
    ${response}  POST Request By Driver Id  ${data}  ${headers}
