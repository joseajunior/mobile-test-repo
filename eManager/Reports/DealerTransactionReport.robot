...
*** Test Cases ***
Dealer Transaction Report - Restricted chain displayed for CT7 carrier
    [Tags]  JIRA:FRNT-1968  JIRA:FRNT-1981  qTest:54747382  JIRA:BOT-3647
    [Documentation]  Ensure restricted locations are displayed for CT7 carriers in Dealer Transaction Report

	Setup 'a' CT7 Carrier with Dealer Transaction Report Permission
	Log Carrier into eManager with Dealer Transaction Report permission
	Go to Select Program > Reports/Exports > Dealer Transaction Report
...
Dealer Transaction Report - Restricted chain not displayed for non CT7 carrier
    [Tags]  JIRA:FRNT-1968  JIRA:FRNT-1981  qTest:54747380  JIRA:BOT-3647
    [Documentation]  Ensure restricted locations are not displayed for non CT7 carriers in Dealer Transaction Report

	Setup 'non' CT7 Carrier with Dealer Transaction Report Permission
	Log Carrier into eManager with Dealer Transaction Report permission
	Go to Select Program > Reports/Exports > Dealer Transaction Report
	Select the Location ID and click the 'Look Up Location' button
...
*** Keywords ***
Setup '${condition}' CT7 Carrier with Dealer Transaction Report Permission
    [Documentation]  Setup for a/non CT7 carrier with Dealer Transaction Report permission
    ...
    # Ensure carrier has Dealer Transaction Report permission
    Ensure Carrier has User Permission  ${carrier.id}  DEALER_TRANSACTION_REPORT

Log Carrier into eManager with Dealer Transaction Report permission
    [Documentation]  Log carrier into eManager with Dealer Transaction Report permission

    Open eManager  ${carrier.id}  ${carrier.password}

Go to Select Program > Reports/Exports > Dealer Transaction Report
    [Documentation]  Go to Select Program > Reports/Exports > Dealer Transaction Report

    Go To  ${emanager}/cards/DealerTransactionReport.action
