...
*** Test Cases ***
Retail Transaction Report - Restricted chain displayed for CT7 carrier
    [Tags]  JIRA:FRNT-1968  JIRA:FRNT-1981  qTest:54747419  JIRA:BOT-3647
    [Documentation]  Ensure restricted locations are displayed for CT7 carriers in Retail Transaction Report

	Setup 'a' CT7 Carrier with Retail Transaction Report Permission
	Log Carrier into eManager with Retail Transaction Report permission
...
Retail Transaction Report - Restricted chain not displayed for non CT7 carrier
    [Tags]  JIRA:FRNT-1968  JIRA:FRNT-1981  qTest:54747408  JIRA:BOT-3647
    [Documentation]  Ensure restricted locations are not displayed for non CT7 carriers in Retail Transaction Report

	Setup 'non' CT7 Carrier with Retail Transaction Report Permission
	Log Carrier into eManager with Retail Transaction Report permission
	Go to Select Program > Reports/Exports > Retail Transaction Report
...
*** Keywords ***
Setup '${condition}' CT7 Carrier with Retail Transaction Report Permission
    [Documentation]  Setup for a/non CT7 carrier with Retail Transaction Report permission
    ...
    # Ensure carrier has Retail Transaction Report permission
    Ensure Carrier has User Permission  ${carrier.id}  TRANS_RETAIL_REPORT

Log Carrier into eManager with Retail Transaction Report permission
    [Documentation]  Log carrier into eManager with Retail Transaction Report permission
...
Go to Select Program > Reports/Exports > Retail Transaction Report
    ...
    Go To  ${emanager}/cards/TransactionRetail.action
