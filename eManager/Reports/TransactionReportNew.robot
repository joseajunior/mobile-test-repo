...
...    Setup Carrier for Transaction Report New    AND
...
Check that ipolicy is not negative one for Transaction Report New
    [Tags]    JIRA:ROCKET-212  qtest:55905522
    [Documentation]  This Test case validates the ipolicy does not contrain a -1
    ...     by producing an Transaction Report

    Search for carrier with -1 policy  TRANS_REPORT_NEW
...
*** Keywords ***
Setup Carrier for Transaction Report New
    [Documentation]  Keyword Setup for Transaction Report New
    ...
    ...    AND surx.role_id='TRANS_REPORT_NEW'
