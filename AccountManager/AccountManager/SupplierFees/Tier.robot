...
*** Test Cases ***
Update error handling on Supplier Tabs - Tier
    [Tags]  Q2:2023    JIRA:OT-16  qTest:120515334    API:Y
    [Documentation]  Open, close and open again Add New Tier Fee tabs to verify that the fields BY PRODUCT,
...
Go to Tier Tab
    [Tags]  qtest
    [Documentation]    Go to Tier Tab
    Wait Until Element Is Visible  //a[@id='sfsTiers']
    Click Element  //a[@id='sfsTiers']
