...
*** Test Cases ***
Autorefresh limits for Site Policies in Add option
    [Tags]  Q2:2023    JIRA:OT-03  qTest:120667342    API:Y
    [Documentation]  Check if the Autorefresh limits for Site Policies in Add option are working
    ...
    Go to Site Policies Tab
    Click On Site Policies Submit Button
    Select The First Site Policy Of The Grid
    Go to Products Tab
    Click On Add Button
    Select Type Refresh
...
Autorefresh limits for Site Policies in Edit option
    [Tags]  Q2:2023    JIRA:OT-03  qTest:120667357    API:Y
    [Documentation]  Check if the Autorefresh limits for Site Policies while edit are working
...
Go to Site Policies Tab
    ...
    Wait Until Element Is Visible    //a[@id='SitePolicies']
    Click Element  //a[@id='SitePolicies']

Click On Site Policies Submit Button
    [Tags]  qtest
    [Documentation]    Click On Site Policies Submit Button
    Wait Until Element Is Visible    //*[@id="customerSitePoliciesSearchContainer"]
    Click Element    //*[@id="customerSitePoliciesSearchContainer"]
    Wait Until Loading Spinners Are Gone

Select The First Site Policy Of The Grid
    [Tags]  qtest
    [Documentation]    Select The First Site Policy Of The Grid
