...
Valid Input With A Single Result
    [Tags]  tier:0  JIRA:BOT-1576  qTest:31433122  Regression  refactor
    ${db_transactions}  Get DB Transactions  ${parent_carrier}  2018-12-01  2018-12-30
    ${ws_transaction}  getChildTransactions  2018-12-01  2018-12-30
...
Valid Input
    [Tags]  tier:0  JIRA:BOT-1576  qTest:31419731  Regression  refactor
    ${db_transactions}  Get DB Transactions  ${parent_carrier}  2018-11-01  2018-11-07
    ${ws_transactions}  getChildTransactions  2018-11-01  2018-11-07
    Format WS Data  ${ws_transactions}
    Format DB Data  ${db_transactions}
...
Search Child Transactions Using Only Begin Date
    [Tags]  JIRA:BOT-1576  qTest:31419732  Regression
    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-24  ${empty}  00:00:00  ${empty}
    Should Not Be True  ${status}

Search Child Transactions Using Only End Date
    [Tags]  JIRA:BOT-1576  qTest:31419733  Regression
    ${status}  Run Keyword And Return Status  getChildTransactions  ${empty}  2019-03-24  ${empty}  00:00:00
    Should Not Be True  ${status}

Search Child Transactions Using Null Parameters
    [Tags]  JIRA:BOT-1576  qTest:31419734  Regression
    ${status}  Run Keyword And Return Status  getChildTransactions  ${empty}  ${empty}  ${empty}  ${empty}
    Should Not Be True  ${status}

Search Child Transactions Using Date on Future
    [Tags]  JIRA:BOT-1576  qTest:31419735  Regression

    ${beginDate}  GetDateTimeNow  %Y-%m-%d  days=1
    ${endDate}  GetDateTimeNow  %Y-%m-%d  days=2

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}
    Should Not Be True  ${status}

Search Child Transactions With a Typo On the Date
    [Tags]  JIRA:BOT-1576  qTest:31419725  Regression
...
#   TYPO ON THE BEGIN DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-2X  ${endDate}
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-?!-25  ${endDate}
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  201@-03-25  ${endDate}
    Should Not Be True  ${status}

#   TYPO ON THE END DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  2019-03-2X
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  2019-?!-25
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  201@-03-25
    Should Not Be True  ${status}

Search Child Transactions With Extra Character On the Time
    [Tags]  JIRA:BOT-1576  qTest:31419726  Regression
...
#   EXTRA CHARACTER ON THE BEGIN TIME
    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  000:59:59  00:00:00
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:599:00  00:00:00
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:59:599  00:00:00
    Should Not Be True  ${status}

#   EXTRA CHARACTER ON THE END TIME

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:00:00  233:59:59
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:00:00  23:599:59
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:00:00 23:59:599
    Should Not Be True  ${status}

Search Child Transactions With Extra Character On the Date
    [Tags]  JIRA:BOT-1576  qTest:31419727  Regression
...
#   EXTRA CHARACTER ON THE BEGIN DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  20190-03-25  ${endDate}
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-003-25  ${endDate}
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-250  ${endDate}
    Should Not Be True  ${status}

#   EXTRA CHARACTER ON THE END DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  20190-03-25
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  2019-003-25
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  2019-03-250
    Should Not Be True  ${status}

Search Child Transactions With Invalid Date
    [Tags]  JIRA:BOT-1576  qTest:31419728  Regression
...
#   INVALID BEGIN DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-65  ${EndDate}
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-15-26  ${EndDate}
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  0000-03-10  ${EndDate}
    Should Not Be True  ${status}

#INVALID END DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  ${BeginDate}  2019-03-65
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${BeginDate}  2019-15-26
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${BeginDate}  00193-03-10
    Should Not Be True  ${status}

Search Child Transactions With Incomplete Dates
    [Tags]  JIRA:BOT-1576  qTest:31419729  Regression
...
#   INCOMPLETE BEGIN DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  201-03-25  2019-03-10
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-3-25  2019-03-10
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-5  2019-03-10
    Should Not Be True  ${status}

#   INCOMPLETE END DATE
    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-10  201-03-25
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-10  2019-3-10
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  2019-03-10  2019-03-0
    Should Not Be True  ${status}

Search Child Transactions With Incomplete Times
    [Tags]  JIRA:BOT-1576  qTest:31419730  Regression
    [Documentation]  Validate that's not possible to get transactions searching by an incomplete date format (06 scenarios)
...
#   INCOMPLETE BEGIN TIME
    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  2:59:59  00:00:00
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  23:5:59  00:00:00
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  23:59:4  00:00:00
    Should Not Be True  ${status}

#   INCOMPLETE END TIME
    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:00:00  2:59:59
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:00:00  23:5:59
    Should Not Be True  ${status}

    ${status}  Run Keyword And Return Status  getChildTransactions  ${beginDate}  ${endDate}  00:00:00  23:59:0
    Should Not Be True  ${status}
