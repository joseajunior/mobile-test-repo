...
Valid Input
    ...
    [Documentation]
    ${ws_return}  issueNewPayrollCard  ${shipToFirst}  ${shipToLast}  ${shipToAddress1}  ${shipToAddress2}  ${shipToCity}  ${shipToState}  ${shipToZip}  ${shipToCountry}  ${shippingMethod}  ${rushProcessing}
...
Issue With Invalid Shipping Method
    ...
    ${status}  run keyword and return status  issueNewPayrollCard  ${shipToFirst}  ${shipToLast}  ${shipToAddress1}  ${shipToAddress2}  ${shipToCity}  ${shipToState}  ${shipToZip}  ${shipToCountry}  ${shippingMethod}  ${rushProcessing}
