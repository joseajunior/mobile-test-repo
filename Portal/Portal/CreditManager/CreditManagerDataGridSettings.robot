...
*** Test Cases ***
Credit Manager data grid settings
    [Tags]    JIRA:ATLAS-2389    JIRA:BOT-5090    qTest:120359398   Q2:2023
    [Documentation]    Ensure data grid settings doesn't throw null pointer in Credit Manager
...
Perform general search
    ...
    Wait Until Element is Visible    name=request.search.name
    Select Checkbox    //*[@name="__request.search.nameContains"]
    Input Text    name=request.search.name    the
...
Remove result column
    ...
    Open data grid settings
    Wait Until Element is Visible    //*[@id="_j_dataGrid_fields"]//input[@value='orgName']
    Unselect Checkbox    //*[@id="_j_dataGrid_fields"]//input[@value='orgName']
    Click to update settings and wait data loading
    Ensure page has no null pointer error
    Page Should Not Contain Element    //*[@id="resultsTable"]//div[contains(text(), 'Issuer Group')]
...
Add result column
    ...
    Open data grid settings
    Wait Until Element is Visible    //*[@id="_j_dataGrid_fields"]//input[@value='orgName']
    Select Checkbox    //*[@id="_j_dataGrid_fields"]//input[@value='orgName']
    Click to update settings and wait data loading
    Ensure page has no null pointer error
    Page Should Contain Element    //*[@id="resultsTable"]//div[contains(text(), 'Issuer Group')]
